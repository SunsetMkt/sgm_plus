# https://github.com/magenta/magenta-js/issues/164#issuecomment-1563429496
import json
import os
            ...
            for velocity in instrument_data['velocities']:
                ...
                for pitch in pitches:
                    ...
                    if os.path.exists(f"{instrument_name}/{file_name}"):
                        print(
                            f"Skipping {instrument_name}/{file_name} - File already exists")
                        ...
                        try:
                            ...
                            print(
                                f"Failed to download {instrument_name}/{file_name}")
